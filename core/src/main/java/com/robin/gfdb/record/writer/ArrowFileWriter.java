...
public class ArrowFileWriter extends AbstractFileWriter{
    ...
    public ArrowFileWriter(DataCollectionMeta colmeta, AbstractFileSystem fileSystem) {
    ...
    public void initalize() throws IOException {
        ...
        streamWriter = new ArrowStreamWriter(vectorSchemaRoot, new DictionaryProvider.MapDictionaryProvider(), Channels.newChannel(outputStream), IpcOption.DEFAULT,factory,codecType);
    ...
    void writeValue(Field field, DataSetColumnMeta meta, int row, Map<String, Object> valueMap) throws UnsupportedEncodingException {
