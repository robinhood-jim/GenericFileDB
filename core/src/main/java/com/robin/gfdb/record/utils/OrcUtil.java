...
public class OrcUtil {
    ...
    public static void parseOperator(AbstractFileReader reader, SqlNode node, SearchArgument.Builder argumentBuilder){
    ...
    public static void walkCondition(AbstractFileReader reader, SqlNode node, SearchArgument.Builder argumentBuilder){
