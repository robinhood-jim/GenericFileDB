...
import com.robin.gfdb.cloud.outputstream.COSOutputStream;
...
@Slf4j
@Getter
public class COSFileSystem extends AbstractCloudStorageFileSystem {
    private COSClient cosClient;
    private String regionName;
    private HttpProtocol protocol=HttpProtocol.http;
    private String securityKey;
    private String accessKey;
    private COSFileSystem(){
    ...
    public static class Builder{
        private COSFileSystem accessor;
        public Builder(){
            accessor=new COSFileSystem();
        }
