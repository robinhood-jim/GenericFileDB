...
import com.robin.gfdb.cloud.outputstream.QiniuOutputStream;
...
@Slf4j
@Getter
public class QiniuFileSystem extends AbstractCloudStorageFileSystem {
    ...
    protected synchronized OutputStream getOutputStream(String path) throws IOException {
        return new QiniuOutputStream(client,uploadManager,metaLocal.get(),auth,getBucketName(metaLocal.get()),path,urlPrefix);
    }
    ...
    public static class Builder{
        private QiniuFileSystem accessor;
        public Builder(){
            accessor=new QiniuFileSystem();
        }
