...
import com.robin.gfdb.cloud.outputstream.OSSOutputStream;
 ...
 */
@Getter
public class OSSFileSystem extends AbstractCloudStorageFileSystem {
    ...
    protected synchronized OutputStream getOutputStream(String path) throws IOException {
        return new OSSOutputStream(ossClient,metaLocal.get(),getBucketName(metaLocal.get()),path,region);
    }
    ...
    public static class Builder{
        private OSSFileSystem accessor;
        public Builder(){
            accessor=new OSSFileSystem();
        }
