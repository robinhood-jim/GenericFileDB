...
public class EtcdClient {
    ...
    private static EtcdClient discovery;
    ...
    public static class Builder {
        private static EtcdClient discovery = new EtcdClient();
    ...
    public static void main(String[] args){
        //EtcdClient discovery1=EtcdClient.Builder.newBuilder().withEndPoint("http://127.0.0.1:2379").build();
